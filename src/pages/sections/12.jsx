...
export default function Program() {
  return (
    <Wrapper>
      ...
      <HomeHero/>
      <LearningSchedule audioPath={"/assets/img/gallery/audio_scenski pokret_vanja evđenić i maryam kristina gbaya.mp3"} audioFileName={"Audio Scenski Pokret"}/>
      
        <div className="bd-gallery-area p-relative pt-120 pb-95 p-relative">
            <div className="container">
                <div style={{marginTop: "-250px"}} className="row">
                    <iframe
                    src="https://player.vimeo.com/video/827745799?h=c0ad8977f2&title=0&sidedock=0&controls=1&autoplay=1&loop=1&muted=1"
                    width="100%"
                    height="771"
