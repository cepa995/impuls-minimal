...
const ProgramDetailsArea = ({item}) => {
    ...
    return (
        <>
            <Breadcrumb title="Detalji Programa" subTitle="Detalji Programa" banner={item.background_image}/>
                                ...
                                <div className="bd-program-details-active">
                                    <div className='bd-h-full'>
                                        ...
                                        >
                                            ...
                                            <SwiperSlide>
                                                <div className="bd-program-details-slider-thumb">
                                                    <Image src={item.img_2} style={{ width: "100%", height: "100%" }} alt="img not found" />
                                                </div>
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <div className="bd-program-details-slider-thumb">
                                                    <Image src={item.img_3} style={{ width: "100%", height: "100%" }} alt="img not found" />
                                                </div>
                                            </SwiperSlide>
                                        </Swiper>
                                    </div>
            ...
            <ProgramCat dateStart={item.date_start} duration={item.duration}/>
            <ClassDetailsWidget />
            <LearningSchedule />
