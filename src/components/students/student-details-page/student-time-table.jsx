                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-8">
                            <div className="bd-section-title-wrapper text-center mb-55 wow fadeInUp" data-wow-duration="1s"
                                data-wow-delay=".3s">
                                <h2 className="bd-section-title mb-0">Moja I'mpuls Vremenska Tabla</h2>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div className="bd-routine-2">
                                        <div className="table-responsive d-none d-md-block">
                                            <table className="table">
                                                <thead>
                                                    <tr>
                                                        <th scope="col" className="clr-4">Nedelja</th>
                                                        <th scope="col" className="clr-5">Ponedeljak</th>
                                                        <th scope="col" className="clr-4">Utorak</th>
                                                        <th scope="col" className="clr-5">Sreda</th>
                                                        <th scope="col" className="clr-4">Četvrtak</th>
                                                        <th scope="col" className="clr-5">Petak</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
