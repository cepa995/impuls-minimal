...
const Breadcrumb = ({title, subTitle, banner}) => {
    
    const backgroundBanner = "/assets/img/bg/" + banner;
    console.log(bg)
    console.log(backgroundBanner)
    return (
        <section className="bd-breadcrumb-area p-relative fix theme-bg">
            <div className="bd-breadcrumb-bg" style={{ backgroundImage: `url(${backgroundBanner})` }}></div>
                            ...
                            <div className="bd-breadcrumb d-flex align-items-center justify-content-center">
                                <div className="bd-breadcrumb-content text-center">
                                    ...
                                    <div className="bd-breadcrumb-list">
                                        <span><Link href="/"><i className="flaticon-hut"></i>Impuls</Link></span>
                                        <span>{subTitle}</span>
                                    </div>
                                </div>
                            </div>
