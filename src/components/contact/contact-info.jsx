                        ...
                        <div className="bd-contact-info-wrap mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                            <div className="bd-contact-info">
                                <div className="bd-contact-info-content">
                                    ...
                                    <h6><a href="#">Trg Dositeja Obradovića, 21000 Novi Sad</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="bd-contact-info">
                                <div className="bd-contact-info-content">
                                    <div className="bd-contact-info-icon cat-3">
                                        <a href="mailto:support@impuls.com"><i className="flaticon-email"></i></a>
                                    </div>
                                    <h6><a href="mailto:support@impuls.com">support@impuls.com</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
